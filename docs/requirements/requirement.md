...
Messages shall be stored persistently and displayed in chronological order. Users shall be able to scroll through very old history using infinite scroll. Messages sent to an offline user are persisted and delivered when the recipient next opens the application.
